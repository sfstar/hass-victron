...
battery_detail_registers = {
    ...
    "battery_system_mincellvoltage": RegisterInfo(1290, UINT16, UnitOfElectricPotential.VOLT, 1000),
    "battery_system_maxcellvoltage": RegisterInfo(1291, UINT16, UnitOfElectricPotential.VOLT, 1000),
